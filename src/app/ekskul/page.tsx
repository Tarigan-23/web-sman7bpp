...
// 1. Data Dummy Ekskul (Bisa Anda sesuaikan isinya nanti)
const dataEkskul = [  
  {
    id: 1,
    nama: "Pramuka",
    kategori: "Umum",
    logo: "/", // Sesuaikan dengan file gambar di folder public Anda
    pembina: "Budi Santoso, S.Pd.",
    ketua: "Andi Wijaya",
    wa: "6281234567890", // Gunakan format kode negara tanpa tanda +
  ...
  },
  {
    ...
    wa: "6287766554433",
    jadwal: "Selasa & Kamis, 16:00 WITA",
    deskripsi: "Mengembagkan Bakat berkuda, fisik yang prima, serta persiapan kompetisi antar sekolah."
  },
]
...
export default function EkskulPage() {
  ...
  // Menghitung statistik ekskul secara otomatis berdasarkan data
  ...
  // Menyaring data berdasarkan tab kategori yang diklik
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 pt-32 pb-20 px-6">
        ...
        {/* === PERBAIKAN DI SINI: STATISTIK COUNTER (1 Baris Kesamping & Latar Lebih Tebal) === */}
        <div className="max-w-5xl mx-auto bg-white/15 backdrop-blur-lg border border-white/20 p-6 rounded-3xl shadow-2xl mb-12 overflow-x-auto no-scrollbar">
          <div className="flex justify-between items-center gap-6 min-w-max px-4">
            
            <div className="text-center flex-1 px-4">
              <div className="text-4xl font-black text-blue-400 drop-shadow">{totalEkskul}</div>
              <div className="text-sm font-bold text-white mt-1 uppercase tracking-wider">Ekskul Aktif</div>
            </div>

            <div className="h-10 w-[1px] bg-white/20 hidden sm:block"></div> {/* Garis Pembatas */}

            <div className="text-center flex-1 px-4">
              <div className="text-4xl font-black text-white drop-shadow">{totalUmum}</div>
              <div className="text-sm font-semibold text-gray-200 mt-1 uppercase tracking-wider">Umum</div>
            </div>

            <div className="h-10 w-[1px] bg-white/20 hidden sm:block"></div> {/* Garis Pembatas */}

            <div className="text-center flex-1 px-4">
              <div className="text-4xl font-black text-white drop-shadow">{totalOlahraga}</div>
              <div className="text-sm font-semibold text-gray-200 mt-1 uppercase tracking-wider">Olahraga</div>
            </div>

            <div className="h-10 w-[1px] bg-white/20 hidden sm:block"></div> {/* Garis Pembatas */}

            <div className="text-center flex-1 px-4">
              <div className="text-4xl font-black text-white drop-shadow">{totalAkademik}</div>
              <div className="text-sm font-semibold text-gray-200 mt-1 uppercase tracking-wider">Akademik</div>
            </div>

            <div className="h-10 w-[1px] bg-white/20 hidden sm:block"></div> {/* Garis Pembatas */}

            <div className="text-center flex-1 px-4">
              <div className="text-4xl font-black text-white drop-shadow">{totalKeagamaan}</div>
              <div className="text-sm font-semibold text-gray-200 mt-1 uppercase tracking-wider">Keagamaan</div>
            </div>
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-16">
          {["Semua", "Olahraga", "Akademik", "Keagamaan", "Umum"].map((kategori) => (
            <button
              ...
              className={`px-6 py-2.5 rounded-xl font-medium transition duration-300 text-sm ${
          ...
          {ekskulTersaring.map((ekskul) => (
            ...
            >
              ...
              <div className="p-6 flex-1 flex flex-col">
                {/* 📌 POSISI BARU: Kategori dipindah ke atas nama ekskul */}
                <div className="mb-2">
                ...
                {/* Informasi Pengurus & Jadwal (Kebutuhan Kustom Anda) */}
